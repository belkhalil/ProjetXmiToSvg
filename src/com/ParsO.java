...
public class ParsO {
	...
	public ParsO(Namespace uml, Namespace xmi, String name, String id,
	...
	public static void dessinerControl(Controlflow courant1, Element svg){
		   ...
		   if(haute==eyt1)
		   {
			...
			Attribute stroke1=new Attribute("stroke","purple");
			Attribute stroke_width1=new Attribute("stroke-width","2");
			Attribute fill1=new Attribute("fill","white");
		    Attribute point=new Attribute("points",""+ext1+","+haute+" "+(ext1+6)+","+(haute-12)+" "+(ext1-6)+","+(haute-12)+" ");
	...
	public static void main(String[] args) throws  Throwable {
        ...
        String fichier="C://Users/Oùùm(Y)/Desktop/xml/src/file.xmi";
